...
//            System.out.println(ctx.getChild(2).getText() + " " + ctx.getChild(3).getText());
    ...
    public void exitEnhancedForControl(@NotNull JavaParser.EnhancedForControlContext ctx) {
        if (ctx.Identifier() != null) {
            ...
            if (Utils.listContainsItem(Utils.NGMON_ALLOWED_TYPES, ctx.type().getText().trim())) {
...
//                System.out.println("ec=" + ec.getText());
     ...
     * @param isSpecial  not used! If true, first argument/expression contains declaration of whole log ( '%s' '{}')
     */
...
//                System.out.println("SU=" + findMeText);
            ...
            } else if (findMeText.contains("new") && findMeText.contains("Path")) {
...
//                System.out.println("2=" + findMeText);
            ...
            } else if (findMeText.contains("new") && findMeText.contains("[]") && findMeText.trim().endsWith("}")) {
                ...
                ngmonNewName = removeDotsAndBracketsFromText(varName);
