 ...
 */
package resources.ProjectTesting.testdir1;

import log_events.resources.ProjectTesting.Testdir1Namespace;
...
public class ThreadUtil {
  ...
  private static final /* LogLOG=LogFactory.getLog(ThreadUtil.class); */
			Testdir1Namespace LOG = LoggerFactory.getLogger(Testdir1Namespace.class, new SimpleLogger());
  ...
  public static void sleepAtLeastIgnoreInterrupts(long millis) {
    ...
    while (Time.now() - start < millis) {
      ...
      try {
        ...
        LOG.interrupted_while_sleeping(ie).warn();
      }
    }
  }
}
