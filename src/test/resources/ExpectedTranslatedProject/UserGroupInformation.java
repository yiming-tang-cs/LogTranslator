 ...
 */
package resources.ProjectTesting;
...
import log_events.resources.ProjectTestingNamespace;
...
public class UserGroupInformation {
  private static final /* LogLOG=LogFactory.getLog(UserGroupInformation.class); */
			ProjectTestingNamespace LOG = LoggerFactory.getLogger(ProjectTestingNamespace.class, new SimpleLogger());
  /**
   ...
   *
   * @throws java.io.IOException        if the kerberos login fails
   */
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  ...
  public <T> T doAs(PrivilegedExceptionAction<T> action
    ...
    try {
      ...
      if (LogGlobal.isDebugEnabled()) {
        ...
        LOG.privilegedactionexception_cause(this, cause.toString()).debug();
      }
  ...
  private void logPrivilegedAction(Subject subject, Object action) {
    if (LogGlobal.isDebugEnabled()) {
      ...
      LOG.privilegedaction_from(this, where).debug();
    }
  }
