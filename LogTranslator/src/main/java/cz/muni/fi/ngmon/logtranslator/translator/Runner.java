...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        try {
            antlrInputStream = new FileInputStream(propLoader.getTestingFile());
            ...
            LogListener listener = new LogListener(tokens);
            walker.walk(listener, tree);

            System.out.println("\nOutput=\n" + listener.storage.get(tree).getContent());
//            ParseTreeProperty<Changer> map = listener.getStorageValue();
//
//            for (ParseTree pt : map.getKeySet()) {
//                Changer ch = (Changer) map.get(pt);
//                System.out.println(pt.getText() + ch);
//            }

            rewriter.
            System.out.println("original=" + listener.getRewriter().toString());
            System.out.println("modified=" + listener.getRewriter().toString());
